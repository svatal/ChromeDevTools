...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome
{
	public static class ProtocolName
	{
		...
		public static class Emulation
		{
			...
			public const string VirtualTimeAdvanced = "Emulation.virtualTimeAdvanced";
		...
		public static class HeadlessExperimental
		{
			...
			public const string MainFrameReadyForScreenshots = "HeadlessExperimental.mainFrameReadyForScreenshots";
