...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Input
{
	...
	public class DispatchKeyEventCommand: ICommand<DispatchKeyEventCommandResponse>
	{
		...
		/// <summary>
		/// Gets or sets Text as generated by processing a virtual key code with a keyboard layout. Not needed for for `keyUp` and `rawKeyDown` events (default: "")
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		...
		/// <summary>
		/// Gets or sets Whether the event was from the left or right side of the keyboard. 1=Left, 2=Right (default: 0).
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
