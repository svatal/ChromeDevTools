...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.DOMSnapshot
{
	...
	public class DOMNode
	{
		...
		/// <summary>
		/// Gets or sets The indexes of the node's child nodes in the `domNodes` array returned by `getSnapshot`, if any.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		...
		/// <summary>
		/// Gets or sets Indexes of pseudo elements associated with this node in the `domNodes` array returned by `getSnapshot`, if any.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public long[] PseudoElementIndexes { get; set; }
		/// <summary>
		/// Gets or sets The index of the node's related layout tree node in the `layoutTreeNodes` array returned by `getSnapshot`, if any.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		...
		/// <summary>
		/// Gets or sets The index of a frame owner element's content document in the `domNodes` array returned by `getSnapshot`, if any.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public long? ContentDocumentIndex { get; set; }
		/// <summary>
		/// Gets or sets Index of the imported document's node of a link element in the `domNodes` array returned by `getSnapshot`, if any.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public long? ImportedDocumentIndex { get; set; }
		/// <summary>
		/// Gets or sets Index of the content node of a template element in the `domNodes` array returned by `getSnapshot`.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
